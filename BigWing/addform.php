...
<body class="sub_page">
  ...
  <section class="contact_section layout_padding">
    ...
    <div class="container">
      <form  action="ajout2.php" enctype="multipart/form-data" method="post" >
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="inputNameP">Nom du Produit</label>
            <input type="text" class="form-control" id="inputNameP" name="inputNameP" required/>
          </div>
          <div class="form-group col-md-6">
            <label for="inputlink">Image représantant votre Produit</label>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="inputdesc" name="inputdesc" required/>
        </div>
    </div>
